...
-- return cursor to last place after restart
-- adapted from https://github.com/ethanholz/nvim-lastplace/blob/main/lua/nvim-lastplace/init.lua
-- by @lewis6991: https://github.com/neovim/neovim/issues/16339#issuecomment-1348133829
...
require("luasnip").config.set_config({
  ...
  -- Use Ctrl-Tab to trigger visual selection
...
-- Set keymap for reloading snippets
